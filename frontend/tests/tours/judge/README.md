...
- **judge** — the LLM (`adapter/`) owns the semantic residue: **CON-042[0]** ("warns cannot be undone"), **DSH-001[1]** (the redirect does not present as broken/blank — intent-level), and **DSH-004[2]** (error-reason faithfulness), plus **CON-043[5]** as a fallback when the verifier can't bind the success wording.
