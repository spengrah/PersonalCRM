...
| `phone_calls` (Phone + FaceTime via CallHistoryDB) | event stream | `phone`, `email` (generic; channel via `service` column) | direction, duration, answered/missed, service tag | 2026-01-01 | no |
